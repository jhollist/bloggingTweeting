...
install.packages("hollisterOnline2014_1.0.tar.gz", repos=NULL,type="source")
require(hollisterOnline2014)
```
...
----------------------
```{r milsteadFigure, echo=FALSE, fig.cap="Article Views for Milstead et al. (2013).  Annotations on graph indicate that date when blog posts/tweets were published.", message=FALSE}
milsteadFig("10.1371/journal.pone.0081457")
```

```{r hollisterFigure, echo=FALSE, fig.cap="Article Views for Hollister et al. (2011).  Annotations on graph indicate the general time frame when online activity (e.g. Blogging, curating bibliographic sites, tweeting, etc.) was initiated.", message=FALSE}
hollisterFig("10.1371/journal.pone.0025764")
```
